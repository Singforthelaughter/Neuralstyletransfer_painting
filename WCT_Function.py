...
def encoder1_1():
  ...
  t7 = torchfile.load('./wct_models/vgg_normalised_conv1_1.t7',force_8bytes_long=False, use_list_heuristic = False)
  x = inp
...
def encoder2_1():
  inp = Input(shape=(None, None, 3), name='vgg_input')
  t7 = torchfile.load('./wct_models/vgg_normalised_conv2_1.t7',force_8bytes_long=False, use_list_heuristic = False)
  x = inp
...
def encoder3_1():
  inp = Input(shape=(None, None, 3), name='vgg_input')
  t7 = torchfile.load('./wct_models/vgg_normalised_conv3_1.t7',force_8bytes_long=False, use_list_heuristic = False)
  x = inp
...
def encoder4_1():
  inp = Input(shape=(None, None, 3), name='vgg_input')
  t7 = torchfile.load('./wct_models/vgg_normalised_conv4_1.t7',force_8bytes_long=False, use_list_heuristic = False)
  x = inp
...
def encoder5_1():
  inp = Input(shape=(None, None, 3), name='vgg_input')
  t7 = torchfile.load('./wct_models/vgg_normalised_conv5_1.t7',force_8bytes_long=False, use_list_heuristic = False)
  x = inp
...
def decoder1_1():
  ...
  t7 = torchfile.load('./wct_models/feature_invertor_conv1_1.t7',force_8bytes_long=False, use_list_heuristic = False)
  x = inp
...
def decoder2_1():
  ...
  t7 = torchfile.load('./wct_models/feature_invertor_conv2_1.t7',force_8bytes_long=False, use_list_heuristic = False)
  x = inp
...
def decoder3_1():
  ...
  t7 = torchfile.load('./wct_models/feature_invertor_conv3_1.t7',force_8bytes_long=False, use_list_heuristic = False)
  x = inp
...
def decoder4_1():
  ...
  t7 = torchfile.load('./wct_models/feature_invertor_conv4_1.t7',force_8bytes_long=False, use_list_heuristic = False)
  x = inp
...
def decoder5_1():
  inp = Input(shape=(None, None, 512), name='vgg_input')
  t7 = torchfile.load('./wct_models/feature_invertor_conv5_1.t7',force_8bytes_long=False, use_list_heuristic = False)
  x = inp
